...
public class RisonParser extends ParserBase {
    ...
    private final static int INT_APOSTROPHE = '\'';
    private final static int INT_1 = '1';
    private final static int INT_2 = '2';
    private final static int INT_3 = '3';
    private final static int INT_4 = '4';
    private final static int INT_5 = '5';
    private final static int INT_6 = '6';
    private final static int INT_7 = '7';
    private final static int INT_8 = '8';
    private final static int INT_f = 'f';
    private final static int INT_n = 'n';
    private final static int INT_t = 't';
    private final static int INT_DECIMAL_POINT = '.';
    ...
    */
    ...
    public RisonParser(IOContext ctxt, int jsonFeatures, int risonFeatures, Reader r,
    ...
    */
    ...
    protected void _parseUnquotedString()
            throws IOException, JsonParseException {
    ...
    protected void _parseUnquotedString2()
            throws IOException, JsonParseException {
        char[] outBuf = _textBuffer.getCurrentSegment();
        int outPtr = _textBuffer.getCurrentSegmentSize();
