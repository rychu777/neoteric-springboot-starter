...
public class ElasticsearchReporterTest extends ESIntegTestCase {
    ...
    public void testThatTemplateIsAdded() throws Exception {
        ...
        org.assertj.core.api.Assertions.assertThat(templateData.getMappings().get("_default_")).isNotNull();
    }
    ...
    public void testThatMappingFromTemplateIsApplied() throws Exception {
        ...
        org.assertj.core.api.Assertions.assertThat(clusterStateResponse.getState().getMetaData().getIndices().containsKey(indexWithDate)).isTrue();
        IndexMetaData indexMetaData = clusterStateResponse.getState().getMetaData().getIndices().get(indexWithDate);
        org.assertj.core.api.Assertions.assertThat(indexMetaData.getMappings().containsKey("counter")).isTrue();
        ...
        org.assertj.core.api.Assertions.assertThat(mapping.get("index").toString()).isEqualTo("not_analyzed");
    }

    @SuppressWarnings("unchecked")
    private Map<String, Object> getAsMap(Map<String, Object> map, String key) {
        org.assertj.core.api.Assertions.assertThat(map).containsKey(key);
        org.assertj.core.api.Assertions.assertThat(map.get(key)).isInstanceOf(Map.class);
    ...
    public void testThatPercolationNotificationWorks() throws IOException, InterruptedException {
        ...
        org.assertj.core.api.Assertions.assertThat(notifier.metrics.get("myName").name()).isEqualTo(prefix + ".foo");
    ...
    private void assertKey(Map<String, Object> hit, String key, String value) {
        org.assertj.core.api.Assertions.assertThat(hit).containsKey(key);
        org.assertj.core.api.Assertions.assertThat(hit.get(key).toString()).isEqualTo(value);
    }
